...
<section id="landing" class="landing">
  ...
  <section id="security" class="landing-section security"><div><div class="section-kicker">CONTROL WITHOUT COMPROMISE</div><h2>Your computer.<br><span>Your boundaries.</span></h2></div><div class="security-list"><div><b>01</b><h3>Project-scoped access</h3><p>Expose only the folders and projects you choose — not your entire machine.</p></div><div><b>02</b><h3>Permission levels</h3><p>Choose read, operate or admin access for each connected computer.</p></div><div><b>03</b><h3>OAuth-secured MCP</h3><p>Independent authorization for every MCP client with secure account isolation.</p></div><div><b>04</b><h3>Activity visibility</h3><p>Review operations and connection activity from your Lucas dashboard.</p></div></div></section>
  ...
  <section class="final-cta"><div class="cta-glow"></div><div class="section-kicker">THE BRIDGE IS READY</div><h2>Let your AI leave<br>the chat box.</h2><p>Connect intelligence to the computer where the work actually happens.</p><button class="hero-primary" onclick="openAuth()">Get started with Lucas <span>↗</span></button></section>
