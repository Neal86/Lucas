...
from .web_landing_brand import LANDING_LOGO_URL
...
LANDING_HEADER_HTML = r'''<nav class="landing-nav">
    ...
    <div class="landing-logo"><img src="__LANDING_LOGO_URL__" alt="Lucas" /></div>
  ...
  </nav>'''.replace("__LANDING_LOGO_URL__", LANDING_LOGO_URL)
