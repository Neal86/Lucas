...
SETTINGS_EN = {
    ...
    "前台控制 / Focus Control": "Foreground / Focus Control",
    "仅当操作会激活窗口、移动鼠标或向前台窗口发送键盘输入时确认。后台 UI 自动化不会触发。": "Confirm only when an action may activate a window, move the mouse, or send keyboard input to the foreground. Background UI automation does not trigger this."
}
