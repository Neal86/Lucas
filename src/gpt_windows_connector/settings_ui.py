...
def configure_gui(existing: dict[str, object]) -> dict[str, object] | None:
    ...
    NAV_EN = {"常规":"General","账号与插件":"Account & Integrations","安全":"Security","用户与权限":"Users & Permissions","文件访问":"File Access","网络":"Network","任务记录":"Task History","日志":"Logs","系统访问":"System Access"}
    C = {
    ...
    for name in ("常规","账号与插件","安全","用户与权限","文件访问","网络","任务记录","日志","系统访问"):
